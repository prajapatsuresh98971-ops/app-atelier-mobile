  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-between px-6 py-12 bg-background">
      <div className="w-full max-w-md space-y-8 flex-1 flex flex-col justify-center">
        ...
        <h2 className="text-3xl font-bold text-foreground text-center">Remote Device Controls</h2>
        
        <p className="text-lg text-muted-foreground text-center">
          Lock screens, manage apps, and control device access remotely whenever needed
        </p>
      </div>
      ...
      <div className="w-full max-w-md space-y-4">
        ...
        <div className="flex gap-3">
          ...
          <Button 
            className="flex-1"
            onClick={() => navigate("/onboarding/intro-5")}
          >
            Next
          </Button>
        </div>
