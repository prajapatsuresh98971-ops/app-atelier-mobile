...
import { Menu, User, Settings, LogOut, Info, Shield, HelpCircle, Sun, Moon } from "lucide-react";
            ...
            <div className="flex items-center gap-2">
              ...
              <DropdownMenuContent align="end" className="w-56">
                ...
                >
                  ...
                  {theme === 'light' && <span className="text-sm text-muted-foreground">Active</span>}
                </DropdownMenuItem>
                <DropdownMenuItem
                ...
                >
                  ...
                  {theme === 'dark' && <span className="text-sm text-muted-foreground">Active</span>}
                </DropdownMenuItem>
                <DropdownMenuSeparator />
